...
export type WorkspaceDocumentSuggestion = DBTable<"workspace_document_suggestions">

export type WorkspaceDocument = DBTable<"workspace_documents">

export type WorkspaceChat = DBTable<"workspace_chats">

export type WorkspaceChatMessage = DBTable<"workspace_chat_messages">

export type WorkspaceChatVote = DBTable<"workspace_chat_votes">